...
import IndexTable from '@/components/productos/index-table.vue'
import SearchInput from '@/components/shared/search.vue'
import AddButton from '@/components/shared/add-button.vue'
import InfoInput from '@/components/shared/info-input.vue'
...
const info = "Nuevo Producto";
const href = route('producto.create');
const search = "Buscar Producto";
const searchRoute = "/producto";
